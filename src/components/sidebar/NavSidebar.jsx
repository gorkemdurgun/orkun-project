                            ...
                            {item2.children.map((item3,i3) => 
                               item3?.children ? (
                                <SubMenu
                                  ...
                                  label={item3.name}
                                  className={
                                    isActiveNavigation(path, item3)
                                      ? "ui-mobile-active"
                                      : ""
                                  }
                                >
                                  {item3.children.map((item4,i3) => (
                                    <MenuItem
                                      key={i3}
                                      component={<Link href={item4.path} />}
                                      className={
                                        item4.path === path ||
                                        item4.path === path.replace(/\/\d+$/, "")
                                          ? "ui-mobile-active"
                                          : ""
                                      }
                                    >
                                ...
                                <MenuItem
                                  ...
                                  className={
                                    item3.path === path ? "ui-mobile-active" : ""
                                  }
                                >
                                  <span data-bs-dismiss="offcanvas">
                                    {item3.name}
